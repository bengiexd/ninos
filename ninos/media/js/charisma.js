$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','/media/css/bootstrap-'+theme_name+'.css');
	}
...
function docReady(){
	...
	$('.btn-setting').click(function(e){
		...
		$('#myModal').find('.btn-danger').data('id', dataId);
		$('#myModal').modal('show');
	});

	$('#myModal .btn-danger').click(function(e) {
		e.preventDefault();
		var url = $(this).attr('href') + 'delete/' + $(this).data('id') + '/'
		location.href = url;
	});
