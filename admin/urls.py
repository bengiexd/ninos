...
urlpatterns = patterns('admin.views',
	...
	url(r'^cliente/json$',					'json_cliente_view',		name = 'json_cliente_view'),
	...
	url(r'^plato/json$',				'json_plato_view',		name = 'json_plato_view'),
	...
	url(r'^pedido/add$',				'add_pedido_view',		name = 'add_pedido_view'),
